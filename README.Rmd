...
-   `reference.gene.Cq.weighed`: Weighed Cq (or $Cq_{ref}^{w}$) for each reference gene and biological replicate. Calculated as follows: $Cq_{ref}^{w} = Cq \times log_{2}amplification.base_{ref}$
...
-   `GOI.Cq.weighed`: Weighed Cq (or $Cq_{ref}^{w}$) for each gene of interest and biological replicate. Calculated as follows: $Cq_{GOI}^{w} = Cq \times log_{2}amplification.base_{GOI}$
...
<a name="ref2">2. Ganger, M.T., Dietz, G.D. & Ewing, S.J. (2017). A common base method for analysis of qPCR data and the application of simple blocking in qPCR experiments. BMC Bioinformatics, 18. <https://doi.org/10.1186/s12859-017-1949-5></a>
